...
**Cập nhật lần cuối**: 22/04/2026 (v1.0.6)
...
**Trạng thái**: ✅ **SẴN SÀNG PRODUCTION** — Phase 01-18B đã merge về `main` + tag `v1.0.6`.

Brand hiện tại: **GVD next-gen LMS** (thay từ "GVD Simvana" ngày 22/04 tối — tên mới nhấn mạnh vị thế LMS thế hệ mới).

| Item              | Value                                                                  |
| ----------------- | ---------------------------------------------------------------------- |
| Version           | `v1.0.6` (WebGL fullscreen toggle)                                     |
...
| Commit gần nhất   | `1b61de3` (feat(practice): fullscreen toggle button)                   |
