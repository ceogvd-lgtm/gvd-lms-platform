...
export function VerifyEmail({ name, link }: VerifyEmailProps) {
  return (
    <EmailLayout preview={`Xác nhận tài khoản GVD next-gen của ${name}`}>
      ...
      <Text style={{ color: '#475569', fontSize: '15px', lineHeight: '1.6' }}>
        Cảm ơn bạn đã đăng ký <strong>GVD next-gen</strong>. Vui lòng nhấn nút bên dưới để xác nhận
        địa chỉ email. Liên kết có hiệu lực trong <strong>24 giờ</strong>.
      </Text>
      <Button
        href={link}
        style={{
